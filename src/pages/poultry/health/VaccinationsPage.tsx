...
function CreateVaccineProductModal({
  ...
  useEffect(() => {
    const loadMethods = async () => {
      ...
      try {
        // Fetch administration methods directly if the helper is not exported from "@/lib/request"
        const resp = await fetch(`/api/farms/${farm.id}/administration-methods`, {
          headers: {
      ...
      <div className="min-h-screen  p-4 md:p-6">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-bold text-gray-900 mb-2">Vaccinations Management</h1>
